...
object LinearRegression {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //加载数据样本
    val path = "D:\\BaiduNetdiskDownload\\Spark\\尚硅谷大数据第14阶段《Spark（1部分）》\\3.code\\spark\\sparkMLlib\\sparkmllib_linear_regression\\src\\main\\resources\\data.txt";
